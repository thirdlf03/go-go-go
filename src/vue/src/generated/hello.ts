 ...
 * 型の定義
 *
 * @generated from protobuf message myapp.HelloRequest
 */
...
/**
 * @generated from protobuf message myapp.HelloResponse
 */
...
/**
 * @generated MessageType for protobuf message myapp.HelloResponse
 */
export const HelloResponse = new HelloResponse$Type();
/**
 * @generated ServiceType for protobuf service myapp.GreetingService
 */
export const GreetingService = new ServiceType("myapp.GreetingService", [
    { name: "Hello", options: {}, I: HelloRequest, O: HelloResponse },
    { name: "HelloServerStream", serverStreaming: true, options: {}, I: HelloRequest, O: HelloResponse },
    { name: "HelloClientStream", clientStreaming: true, options: {}, I: HelloRequest, O: HelloResponse },
    { name: "HelloBiStreams", serverStreaming: true, clientStreaming: true, options: {}, I: HelloRequest, O: HelloResponse }
]);
